...
const A9 = () => {
  ...
  return (
    <View style={styles.a9}>
      ...
      <Image
        style={[styles.a9Item, styles.iconLayout]}
        resizeMode="cover"
        source={require("../assets/ellipse-6.png")}
      />
      <Image
        style={[styles.a9Inner, styles.iconLayout]}
        resizeMode="cover"
      ...
      <Text style={[styles.title12, styles.titleTypo]}>
        Step 9: Wrist Twist (Left)
      </Text>
      <View style={[styles.groupView, styles.groupLayout]} />
      <Image
        style={styles.component45}
        resizeMode="cover"
        source={require("../assets/component-4--7.png")}
      />
      <Image
        style={[styles.wristTwist11Icon, styles.iconLayout]}
        resizeMode="cover"
        source={require("../assets/wrist-twist1-1.png")}
      />
      <Image
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/wrist-twist2.png")}
      />
      <Pressable
        style={[styles.component218, styles.componentLayout]}
        onPress={() => navigation.navigate("A8")}
      >
      ...
      <Pressable
        style={[styles.component219, styles.componentLayout]}
